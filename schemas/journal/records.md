# The journal record schema, `partman.journal.record` version 1

- Spec version: source of truth is `AGENT_BUILD_SPEC.md` §4.7 (JRN-005,
  JRN-006), Section 8, and MODEL-003/MODEL-005
- Owner: WP-070 (`docs/work-packages/WP-070.md`), increment 3
...
arm; migration is a future reviewed increment. The decoder is strict in
every direction: unknown fields, unknown tags, mistyped positions, and
wrong-length hashes refuse, nothing is repaired, and no refusal echoes
refused content.
...
```text
a5646b696e6471617574686f72697a6174696f6e2d61637464706c616e58201111111111111111111111111111111111111111111111111111111111111111647469657269666c6f6f722d61637466736368656d6176706172746d616e2e6a6f75726e616c2e7265636f72646e736368656d615f76657273696f6e01
```

`transition` (non-terminal, `validator-passes`):

```text

```
...
```text

```

`checkpoint` (step 3):

```text
a5646b696e646a636865636b706f696e7464706c616e5820111111111111111111111111111111111111111111111111111111111111111166736368656d6176706172746d616e2e6a6f75726e616c2e7265636f72646a737465705f696e646578036e736368656d615f76657273696f6e01
```

`protection` (`parse-backup-verified`):

```text

```

`protection` (`absence-determined`):

```text
a56361726d72616273656e63652d64657465726d696e6564646b696e646a70726f74656374696f6e64706c616e5820111111111111111111111111111111111111111111111111111111111111111166736368656d6176706172746d616e2e6a6f75726e616c2e7265636f72646e736368656d615f76657273696f6e01
```
...
```text

```

`compaction` (range 1..=2, `terminal-history-retention`):

```text
a6646b696e646a636f6d70616374696f6e646c617374026566697273740166736368656d6176706172746d616e2e6a6f75726e616c2e7265636f726469617574686f72697479781a7465726d696e616c2d686973746f72792d726574656e74696f6e6e736368656d615f76657273696f6e01
```
