...
//! may invoke an explicitly named absolute Cargo executable with fixed,
//! structured metadata arguments and bounded output.
...
pub use graph::{GraphPhase, GraphReport, verify_graph};
