...
Linux transport — tripped it; and before that
on `454e60b` (2026-08-19 UTC) when WP-L100 PR #516 — FR6 discharged, a
doc comment — tripped it; and before that
on `e2a50e0` (2026-08-19 UTC) when WP-L100 PR #512 — the floor finished
on ADR-0054 — tripped it; and before that
on `94cec12` (2026-08-19 UTC) when WP-L100 PR #507 — obligation 4, the
Debian arm of the floor determination — tripped it; and before that
...
slice, the held standing on DR15 — tripped it; and before that
on `9c14a88` (2026-08-18 UTC) when WP-L100 PR #478 — increment 4b's second
slice, naming what ADR-0053 designates — tripped it; and before that
on `e9c4afe` (2026-08-18 UTC) when the #1006 arc — PRs #472 and #473, one
sitting at the arc's head — tripped it; and before that
on `46ecad5` (2026-08-18 UTC) when WP-L100 PR #469 — increment 4a of the
Linux adapter, the state layer and the withdrawal — tripped it; and before that
on `0378bd5` (2026-08-18 UTC) when the consequence-text body arc — PRs
#461 and #462, one sitting at the arc's head — tripped it; and before that
on `0519285` (2026-08-18 UTC) when the ADR-0052 arc — PRs #455 and
#457, the move, one sitting at the arc's head — tripped it; and before that
on `7b68927` (2026-08-18 UTC) when WP-L100 PR #447 — the Linux
adapter's increment 3a, the first trip in four to ship product behaviour —
...
ADR-0049's planner coverage — WP-060
...
before that on `be6c3f0` when issue #392's act — one Rust merge,
PR #414 (ADR-0048, spec 16.0.0) — tripped it; and before that on
`63ee769` when issue #397's act — one Rust merge,
PR #411 (ADR-0047) — tripped it; and before that on `ca2bc0f` when
issue #333's enforcement arc — three
