...
**No sitting is owed at the time of writing.** The issue-353 arc (PRs
#382 and #384, ADR-0042) shipped Rust after WP-020's r22 pin at `b002ac3`;
the r23 sitting (VMID 9447, 2026-08-16 UTC) discharged it at the arc's
head, and WP-020 is re-pinned at `53c90f1`. The check is
`git diff --name-only 53c90f1 HEAD | grep -v '\.md$'`, and it must be run
