...
taken** (2026-08-02): the register's liveness sequence passed on one reader,
and the same run measured a reset that keeps the witness from supporting the
equality test it exists for. The SI-35 measurements are **not yet taken**.
