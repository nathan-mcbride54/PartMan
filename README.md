...
protocols in `docs/quality/observability.md` with **no measurement yet
taken** — every cell a run can fill reads `not yet taken`. Exit criteria are in
