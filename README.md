...
fact that backs the refusal is a compiled destructive-suite registry whose
shipped state is empty and pinned by test, and a generic request selects no
suite in any case. A pass over no suite remains forbidden.
