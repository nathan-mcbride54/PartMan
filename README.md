...
and the SI-33/SI-28 successor protocol are preregistered in the
observability record with every cell `not yet taken` — instruments awaiting
hardware and operator sittings, not evidence. Exit criteria are in Section 13
