...
**M0.5's loop criterion is satisfied**, pending the record's second-reader
rehash. The run chooses no SI-35 option and supplies no chosen-option
refusal demonstration. Increment 6's macOS and real-partitioned-Linux matrices,
