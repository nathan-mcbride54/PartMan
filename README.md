...
**No sitting is owed at the time of writing.** The body-validity arc
(PRs #377 and #379, ADR-0041) shipped Rust after WP-020's r21 pin at
`b8d6a90`; the r22 sitting (VMID 9446, 2026-08-15 UTC) discharged it at the
arc's head, and WP-020 is re-pinned at `b002ac3`. The check is
`git diff --name-only b002ac3 HEAD | grep -v '\.md$'`, and it must be run
