...
has two sittings: 2026-08-03 found the then-attached pair cross-model
...
units at every serial-bearing layer — leaving only S4's card-move rider
`not yet taken`. Increment 6's macOS and real-partitioned-Linux matrices
and the successor protocol's S1–S3 arms remain preregistered instruments
awaiting operator sittings. Exit criteria are in Section 13 and are not
